...
Le Complément Indemnitaire Annuel (CIA) est la part variable et facultative du régime indemnitaire RIFSEEP. Il récompense l'engagement professionnel et la manière de servir de l'agent.

#### Versement
- Le CIA est versé une fois par an, généralement en mai/juin.

#### Conditions d'éligibilité
- L'agent (titulaire ou contractuel) doit être présent sur le poste au moins **2 mois et demi (soit 75 jours)** sur l'année de référence (N-1).
- Pas d'insuffisance professionnelle majeure.

#### Modalités de calcul
Le calcul se base sur une **Base CIA** égale à **10% du montant de l'IFSE annuel** perçu par l'agent (incluant l'IFSE mensuelle de base ainsi que les primes et indemnités régulières, telles que la valorisation des week-ends travaillés).
Le montant final du CIA est la somme de deux parts égales (50% de la base chacune) :

1. **Part Évaluation professionnelle (50% de la base)**
Cette part est modulée selon le taux de l'évaluation professionnelle annuelle de l'année précédente (N-1) :
- Évaluation "Très satisfaisant" : **100%** de la part
- Évaluation "Satisfaisant" : **70%** de la part
- Évaluation "À consolider" : **50%** de la part
- Évaluation "Non évalué" : **0%** de la part

2. **Part Absences (50% de la base)**
Cette part est impactée par les jours d'absence accumulés durant l'année précédente (N-1) :
- Moins de 6 jours d'absence : **100%** de la part (aucune diminution)
- Entre 6 et 11 jours d'absence : **50%** de la part
- Plus de 11 jours d'absence : **0%** de la part
- *Règle Sécurité Sociale* : Si vous êtes en arrêt maladie du vendredi matin au mardi soir inclus, le week-end est inclus dans le calcul de l'absence, ce qui fait un total de 5 jours.
`;
