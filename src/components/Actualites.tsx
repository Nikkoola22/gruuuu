...
const Actualites: React.FC<ActualitesProps> = ({ news, onClose, baseUrl }) => {
  return (
    <div className="fixed inset-0 z-[60] overflow-y-auto overflow-x-hidden overscroll-contain bg-slate-50">
      {/* Intro Section */}
      <section className="relative z-40 bg-white/95 py-12 text-center border-b border-slate-200 shadow-sm glass-banner">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <p className="text-slate-600 text-lg leading-relaxed text-left font-medium">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-3 bg-white backdrop-blur-xl rounded-3xl p-8 border border-slate-200 shadow-sm">
            <h3 className="text-3xl font-bold text-slate-800 mb-10 pb-4 border-b border-slate-200">
              Actualités
            ...
            <div className="flex flex-col md:flex-row gap-6 mb-12 border-b border-slate-200 pb-10 group/card">
              <div className="relative w-full md:w-72 h-48 overflow-hidden rounded-xl shrink-0 border border-slate-200 bg-slate-50">
                ...
                <span className="absolute top-3 left-3 inline-block text-[11px] font-medium px-2.5 py-1 rounded-full bg-white/90 backdrop-blur text-red-600 border border-red-200 shadow-sm">
                  Statutaire
                </span>
              </div>
              <div className="flex flex-col justify-between">
                <div>
                  <h4 className="text-xl font-bold text-slate-800 mt-1 hover:text-blue-600 transition-colors leading-snug mb-3">
            ...
            {news.length === 0 ? (
              <div className="text-center text-slate-500 font-medium text-lg py-12">
                ...
                {news.map((article, i) => {
                  ...
                  return (
                    <a
                      ...
                      className="group/card w-full flex flex-col bg-white border border-slate-200 rounded-2xl overflow-hidden hover:border-blue-300 hover:shadow-md hover:-translate-y-1 transition-all duration-150 shadow-sm"
                    >
                      {/* Image de l'article avec zoom au survol et fallback sur logo CFDT */}
                      <div className="relative w-full h-40 overflow-hidden bg-slate-100 flex-shrink-0">
                        <img
                        ...
                        />
                        {article.category && (
                          <span className="absolute top-3 left-3 inline-block text-[11px] font-medium px-2.5 py-1 rounded-full bg-white/90 backdrop-blur text-blue-700 border border-blue-200 shadow-sm">
                            {article.category}
                          </span>
                        )}
                      </div>
                      ...
                      <div className="p-5 flex flex-col justify-between flex-grow">
                        <div>
                          <h4 className="text-slate-800 font-bold text-base leading-snug group-hover/card:text-blue-600 transition-colors duration-150 mb-2 line-clamp-3">
                            {article.title}
                          </h4>
                          {article.description && (
                            <p className="text-slate-600 text-sm font-medium line-clamp-3 mb-4">
                              {article.description}
                            </p>
                          )}
                        </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="group bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:border-blue-300 transition-all duration-300 hover:shadow-md">
              <a 
              ...
              >
                <div className="overflow-hidden rounded-lg shadow-sm mb-4 relative flex-grow min-h-[16rem] border border-slate-100 bg-slate-50">
                ...
                <div className="shrink-0 flex flex-col">
                  <h4 className="text-slate-800 text-lg font-bold mb-2">Le Journal de la CFDT</h4>
                  <p className="text-slate-600 text-sm mb-4 leading-relaxed font-medium line-clamp-2">
                    Découvrez la dernière édition de notre journal.
                  </p>
                  <div className="flex items-center justify-center gap-2 w-full bg-white text-blue-700 border border-blue-200 font-bold py-2.5 px-4 rounded-xl shadow-sm hover:bg-blue-50 hover:border-blue-300 transition-all duration-200 transform hover:-translate-y-0.5">
                    Télécharger
