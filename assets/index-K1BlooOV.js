...
`):"Aucun chapitre spécifique trouvé. Thèmes : "+Wi.chapitres.map(s=>s.titre).join(", ")},am=()=>{const[e,t]=b.useState(null),[n,r]=b.useState(!1),[i,s]=b.useState(0),[a,o]=b.useState(0),[l,c]=b.useState(1),[h,g]=b.useState(!0),[v,x]=b.useState(!1),[E,L]=b.useState(null),T=b.useRef(null);b.useEffect(()=>{const f=T.current;if(!f)return;r(!1),s(0),o(0),L(null),x(!1);const M={timeupdate:()=>s(f.currentTime||0),loadedmetadata:()=>{f.duration&&isFinite(f.duration)&&o(f.duration)},canplay:()=>x(!1),ended:()=>{r(!1);const P=xr.findIndex(Z=>Z.id===(e==null?void 0:e.id));P!==-1&&P<xr.length-1&&t(xr[P+1])},error:()=>{x(!1),r(!1),L("Impossible de charger ce podcast. Vérifiez votre connexion.")},loadstart:()=>x(!0),waiting:()=>x(!0),playing:()=>{x(!1),r(!0)},pause:()=>r(!1)};return Object.entries(M).forEach(([P,Z])=>f.addEventListener(P,Z)),f.volume=l,e&&f.load(),()=>{Object.entries(M).forEach(([P,Z])=>f.removeEventListener(P,Z))}},[e,l]);const d=async()=>{const f=T.current;if(!(!f||!e))try{n?f.pause():(x(!0),L(null),await f.play())}catch(j){console.error("Error playing audio:",j),L("Impossible de lire ce podcast."),x(!1),r(!1)}},u=f=>{(e==null?void 0:e.id)!==f.id&&(t(f),r(!1))},p=f=>{if(!f||isNaN(f))return"0:00";const j=Math.floor(f/60),w=Math.floor(f%60).toString().padStart(2,"0");return`${j}:${w}`};return m.jsx("div",{className:`fixed right-4 bottom-4 z-50 transition-all duration-300 ${h?"w-60 h-14":"w-80 h-auto"}`,children:m.jsx("div",{className:"flex flex-col bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 rounded-xl shadow-lg border border-purple-500/30 overflow-hidden p-2",children:h?m.jsxs("div",{className:"flex items-center justify-between w-full",children:[m.jsx("button",{onClick:()=>g(!h),className:"text-white p-1.5 hover:bg-white/10 rounded-full",children:"🔼"}),m.jsx("div",{className:"flex items-center justify-center flex-grow",children:m.jsx("img",{src:"https://mistralaichatupprodswe.blob.core.windows.net/chat-images/assistant/5d/d2/6f/5dd26f3f-6b62-402c-bab8-1b22406d4577/fb5d7e4f-f880-4b41-a8ce-d32dc80a2fc6/44dfc5bd-88df-4e4f-aa36-59edac2065aa/18f726e9-8e67-4ce3-b56e-655d4c5e4050.jpg?sv=2025-01-05&st=2025-08-24T14%3A55%3A58Z&se=2025-08-24T15%3A55%3A58Z&sr=b&sp=rade&sig=FJNAMZdX%2FeB16eMFcwH2JssfLhFzOd7VrPMr9gRBxtk%3D",alt:"Podcasts",className:"w-32 h-10 object-cover rounded-lg"})})]}):m.jsxs("div",{className:"flex flex-col",children:[m.jsxs("div",{className:"flex items-center justify-between gap-2",children:[m.jsx("button",{onClick:()=>g(!h),className:"text-white p-1.5 hover:bg-white/10 rounded-full",children:"🔽"}),e&&m.jsx("button",{onClick:d,className:"bg-purple-600 hover:bg-purple-700 text-white rounded-full p-2",children:n?m.jsx(Vp,{className:"w-5 h-5"}):m.jsx(Hp,{className:"w-5 h-5"})}),m.jsxs("div",{className:"flex-grow flex items-center gap-2",children:[m.jsx(Qp,{className:"w-5 h-5 text-gray-300"}),m.jsx("input",{type:"range",min:"0",max:"1",step:"0.01",value:l,onChange:f=>c(parseFloat(f.target.value)),className:"w-full h-1 bg-purple-300 rounded slider appearance-none"})]})]}),m.jsx("audio",{ref:T,src:e==null?void 0:e.url,preload:"metadata",style:{display:"none"},crossOrigin:"anonymous"}),m.jsxs("div",{className:"mt-4",children:[m.jsx("h4",{className:"text-white font-bold text-center mb-2",children:"Épisodes disponibles"}),m.jsx("ul",{className:"max-h-48 overflow-y-auto",children:xr.map(f=>m.jsx("li",{children:m.jsx("button",{onClick:()=>u(f),className:`block w-full text-left px-3 py-2 rounded-md text-sm text-white mb-1 transition-colors ${(e==null?void 0:e.id)===f.id?"bg-purple-700 font-semibold":"bg-purple-800/60 hover:bg-purple-700/80"}`,children:f.title})},f.id))}),e&&m.jsxs("div",{className:"mt-2 px-2 text-xs text-purple-200",children:[m.jsxs("p",{className:"truncate",children:["Lecture : ",e.title]}),m.jsx("div",{children:m.jsxs("span",{children:[p(i)," / ",p(a)]})}),E&&m.jsx("div",{className:"text-red-300 mt-1",children:E})]})]})]})})})};function om(){const[e,t]=b.useState({currentView:"menu",selectedDomain:null,messages:[],isProcessing:!1}),[n,r]=b.useState(""),[i,s]=b.useState(null),a=b.useRef(null),o=b.useRef(null),l=b.useRef(null);b.useEffect(()=>{var T;(T=a.current)==null||T.scrollIntoView({behavior:"smooth"})},[e.messages]);const c=()=>{setTimeout(()=>{var T;(T=l.current)==null||T.scrollIntoView({behavior:"smooth",block:"start"})},100)},h=T=>{t({currentView:"chat",selectedDomain:T,messages:[{type:"assistant",content:{0:"Bonjour ! Je peux vous aider avec vos questions sur les horaires, congés, ARTT, temps partiel, heures supplémentaires, absences, etc.",1:"Bonjour ! Je peux vous renseigner sur le CPF, les congés de formation, la VAE, les concours, les bilans de compétences, etc. Quelle est votre question ?",2:"Bonjour ! Je suis l'assistant spécialiste du télétravail. Posez-moi vos questions sur la charte, les jours autorisés, les indemnités, etc."}[T],timestamp:new Date}],isProcessing:!1}),c(),setTimeout(()=>{var u;return(u=o.current)==null?void 0:u.focus()},150)},g=()=>{t({currentView:"menu",selectedDomain:null,messages:[],isProcessing:!1}),r(""),s(null)},v=async T=>{const d=await fetch(Zp,{method:"POST",headers:{Authorization:`Bearer ${Yp}`,"Content-Type":"application/json"},body:JSON.stringify({model:"llama-3-sonar-large-32k-online",messages:T})});if(!d.ok){const p=await d.text();throw console.error("Détail de l'erreur API:",p),new Error(`Erreur API (${d.status})`)}return(await d.json()).choices[0].message.content},x=async T=>{let d="";e.selectedDomain===0?d=sm(T):e.selectedDomain===1?d=JSON.stringify(Kp,null,2):e.selectedDomain===2&&(d=Xp);const u=`
